...
begin
  ...
  begin
    // Right wall
    Walls.Right.Visible:=not {$IFNDEF CLR}TChartAccess(Chart).{$ENDIF}DrawRightWallAfter;
    ...
    // Left wall
    Walls.Left.Visible:=not {$IFNDEF CLR}TChartAccess(Chart).{$ENDIF}DrawLeftWallFirst;
