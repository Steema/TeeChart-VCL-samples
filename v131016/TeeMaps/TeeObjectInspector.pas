{**********************************************}
{   Object Inspector.                          }
{   Copyright (c) 2006-2013 by David Berneda   }
{**********************************************}
...
begin
  if TeeEditStrings(Self, TStrings((Sender as TInspectorItem).Data)) then
     DoChanged(TInspectorItem(Sender));
end;
